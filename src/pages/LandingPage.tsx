        ...
        <div className="flex items-center gap-3">
          ...
          <button className="lg:hidden ml-1 p-2" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Menu">
            <div className="space-y-1.5">
              <span
                className={cn(
                  "block w-5 h-0.5 bg-foreground transition-transform",
      ...
      <div className="container mx-auto px-4 sm:px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-xl leading-relaxed">
            Você não precisa de mais ideias. Precisa de estrutura. A Viralize monta seu vídeo frame por frame com
            frameworks de retenção e venda — do gancho ao CTA — em minutos.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 text-sm text-muted-foreground mt-2">
            {["Do prompt ao vídeo: 2–5 minutos", "Copy visual por frame (não é só roteiro)", "Garantia de 7 dias"].map(
              (t) => (
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            {[
              ...
              <div
                key={s.label}
                className="flex items-center gap-2 bg-secondary/60 border border-border/50 rounded-full px-4 py-2"
              >
          ...
          <div className="glass-card p-5 sm:p-7 rounded-2xl border border-border/60 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-5">
              ...
              <div className="flex items-end gap-1.5 h-20">
                {[
                  35, 42, 28, 55, 70, 48, 62, 80, 95, 75, 88, 100, 92, 78, 85, 97, 90, 82, 70, 95, 88, 100, 85, 92, 78,
                  88, 95, 100, 90, 85,
                ].map((h, i) => (
                  <motion.div
                    key={i}
                    ...
                    className={cn("flex-1 rounded-sm min-w-[4px]", h >= 90 ? "gradient-primary" : "bg-primary/30")}
                  />
                ))}
              </div>
        ...
        <div className="h-full w-full flex flex-col md:flex-row gap-4 md:gap-6 p-2 md:p-4 overflow-auto">
          ...
          <div className="flex flex-col items-center gap-2 shrink-0">
            ...
            <div className="flex gap-3 text-xs text-muted-foreground">
              ...
              <span>
                {proofVideo.platform} · {proofVideo.duration}
              </span>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-1">
                {proofVideo.structure.map((s, i) => (
                  <div key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                    <span className="w-5 h-5 rounded-md bg-primary/15 text-primary text-[10px] font-bold flex items-center justify-center shrink-0">
                      {i + 1}
                    </span>
                    {s}
                  </div>
              ...
              <AnimatePresence mode="wait">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <span className="text-[11px] text-muted-foreground text-center leading-snug">
                          A IA cria o roteiro, escolhe as cenas e monta o vídeo completo pra você
                        </span>
                      </button>
                      <div className="border border-border/50 bg-secondary/40 rounded-xl p-6 flex flex-col items-center gap-3 opacity-60 cursor-default">
                        ...
                        <span className="text-[11px] text-muted-foreground text-center leading-snug">
                          Você escreve o roteiro e envia seus próprios vídeos
                        </span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="bg-secondary/60 border border-border/50 rounded-lg px-3 py-2.5 text-sm text-foreground">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="bg-secondary/60 border border-border/50 rounded-lg px-3 py-2.5 text-sm text-foreground">
                        Date criativo com jogo de casal
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="bg-primary/5 border border-primary/30 rounded-lg px-3 py-2.5 text-sm text-foreground">
                          🎤 Karaoke
                        </div>
                      </div>
                    </div>
                    <button
                      onClick={() => setStep(2)}
                      className="gradient-primary text-primary-foreground px-5 py-3 rounded-xl font-semibold text-sm self-end hover:opacity-90 transition-opacity shadow-glow flex items-center gap-2 mt-1"
                    >
                ...
                {step === 2 && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    transition={{ duration: 0.3 }}
                    className="flex flex-col items-center justify-center gap-6 min-h-[280px]"
                  >
                    <motion.div
                      animate={{ rotate: 360 }}
                ...
                {step === 3 && (
                  <motion.div
                    ...
                    className="flex flex-col items-center justify-center gap-5 min-h-[280px]"
                  >
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                    ...
                    <div className="flex gap-3 mt-2">
                      <button
                        ...
                        className="border border-border bg-secondary/50 hover:bg-secondary text-foreground px-5 py-2.5 rounded-xl font-semibold text-xs transition-colors flex items-center gap-2"
                      >
                        <RefreshCw className="h-3.5 w-3.5" /> Recomeçar
                      </button>
                      <Link
                        to="/login"
                        className="gradient-primary text-primary-foreground px-5 py-2.5 rounded-xl font-semibold text-xs hover:opacity-90 transition-opacity shadow-glow flex items-center gap-2"
                      >
...
function FaqSection() {
  ...
  const faqs = [
    {
      q: "A Viralize gera o vídeo pronto ou só o roteiro?",
      a: "Vídeo pronto. Você escolhe o modo (Assistente IA ou Script Manual), configura nicho, objetivo e duração, e a IA gera o vídeo completo com legendas, cenas e edição. Só baixar e postar.",
    },
    {
      q: "Preciso saber editar vídeo?",
      a: "Não. A Viralize faz tudo. Você pode usar vídeos gerados pela IA da Viralize ou fazer upload dos seus próprios clipes. A plataforma monta, edita e adiciona legendas automaticamente.",
    },
    {
      q: "Como funciona o Assistente IA?",
      a: "Você define o nicho, objetivo e tema. A IA gera o roteiro e monta o vídeo automaticamente, dividindo em cenas proporcionais à duração escolhida (1 cena a cada 8 segundos). Suporta vídeos de 8s a 30s.",
    },
    {
      q: "O que é a Análise de Roteiro?",
      a: "É uma ferramenta que avalia seu roteiro usando a metodologia P–C–R (Pergunta, Conflito, Resposta). Você recebe scores de retenção, pico emocional e insights práticos para melhorar seu conteúdo antes de gravar.",
    },
    {
      q: "Posso usar meus próprios vídeos?",
      a: "Sim! No modo de vídeos personalizados, recomendamos enviar 4 clipes de 5 segundos cada. A IA faz a montagem, roteiro e edição. Dica: use o botão 'Buscar Inspiração' para encontrar referências no TikTok e o SnapTik para remover marcas d'água.",
    },
    {
      q: "Posso usar os vídeos comercialmente?",
      a: "Sim. Tudo que você cria é 100% seu. Use em seus canais, para clientes ou revenda.",
    },
    {
      q: "Como funciona a garantia de 7 dias?",
      a: "Se não fizer sentido, pediu cancelamento em até 7 dias e devolvemos 100%. Sem perguntas.",
    },
  ];
          ...
          <div className="max-w-3xl mx-auto mt-10 grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <a
                  href="https://pay.zouti.com.br/checkout"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="flex flex-col items-center text-center space-y-6 max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight font-display">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-400">
                tá jogando no escuro.
              </span>
            </h2>
            <p className="text-muted-foreground text-lg">Entre agora e gere seu primeiro vídeo em minutos.</p>
            <Link
              to="/login"
...
export default function LandingPage() {
  ...
  const [affiliateLinks, setAffiliateLinks] = useState<{ checkout_monthly: string; checkout_lifetime: string } | null>(
    null,
  );
  ...
  const checkoutMonthly = affiliateLinks?.checkout_monthly || "https://pay.zouti.com.br/checkout";
  const checkoutLifetime = affiliateLinks?.checkout_lifetime || "https://pay.zouti.com.br/checkout";
