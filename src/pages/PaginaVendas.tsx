...
function ImpactLine({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <p
      className={cn("text-xl sm:text-2xl lg:text-3xl font-bold font-display text-foreground leading-tight", className)}
    >
      {children}
    </p>
  );
...
const CHECKOUT_MONTHLY = "https://pay.zouti.com.br/checkout";
const CHECKOUT_LIFETIME = "https://pay.zouti.com.br/checkout";
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-20 md:py-32 relative z-10 max-w-3xl text-center flex flex-col items-center gap-8">
        ...
        >
          A Viralize junta catálogo de produtos para afiliação, criação de vídeos virais com IA e tráfego orgânico pelo
          TikTok. Tudo dentro de uma única plataforma.
        </motion.p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <ul className="flex flex-col gap-3 relative z-10">
                {["produto escolhido em minutos", "vídeos virais prontos com IA", "vendas chegando pelo TikTok"].map(
                  (item) => (
  ...
  const steps = [
    {
      ...
      desc: "Acesse o catálogo e escolha um infoproduto ou produto físico do TikTok Shop para promover.",
    },
    {
      num: "02",
      title: "Crie vídeos virais",
      desc: "Use a IA da Viralize para gerar roteiros, copy e estrutura de vídeos com potencial de viralização.",
    },
    {
      num: "03",
      title: "Publique e venda",
      desc: "Poste os vídeos no TikTok e direcione o tráfego orgânico para o seu link de afiliado.",
    },
  ];
...
function FAQSection() {
  ...
  const faqs = [
    {
      q: "O que é a Viralize?",
      a: "A Viralize é uma plataforma que junta catálogo de produtos para afiliação e criação de vídeos virais com IA. Você encontra o produto, cria o vídeo e usa o TikTok para gerar tráfego e vendas.",
    },
    {
      q: "Como funciona o acesso vitalício?",
      a: "Você paga uma única vez (R$245 à vista ou 12x de R$25,19) e tem acesso permanente a todas as funcionalidades, incluindo o catálogo de produtos e o motor de vídeos.",
    },
    {
      q: "Tem garantia?",
      a: "Sim. Você tem 7 dias de garantia incondicional. Se não fizer sentido para você, devolvemos 100% do valor.",
    },
    {
      q: "Preciso ter experiência?",
      a: "Não. A Viralize foi feita para iniciantes. Você escolhe o produto no catálogo, a IA cria o roteiro do vídeo e você só precisa postar.",
    },
    {
      q: "Que tipo de produtos posso promover?",
      a: "O catálogo inclui infoprodutos de plataformas como Kiwify, Hotmart e Monetizze, além de produtos físicos disponíveis no TikTok Shop.",
    },
    {
      q: "Funciona para qualquer nicho?",
      a: "Sim. O catálogo tem produtos de diversos nichos e os frameworks de viralização funcionam independente do mercado que você escolher.",
    },
  ];
        ...
        <ScrollReveal>
          <div className="flex flex-col items-center gap-6">
            <p className="text-lg text-muted-foreground">
              Produto para vender. Vídeo para viralizar. Tráfego para converter.
            </p>
