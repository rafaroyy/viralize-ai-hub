      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Gerencie sua conta, integrações e visualize seu cartão de membro exclusivo.
          </p>
        </div>
        ...
        <Tabs defaultValue="perfil" className="w-full">
          ...
          <TabsContent value="perfil" className="space-y-8">
            {/* Member Card Section */}
            <section className="glass-card p-8 flex flex-col items-center space-y-4">
              <h2 className="font-display text-lg font-semibold text-center">Cartão de Membro</h2>
          ...
          <TabsContent value="integracoes" className="space-y-6">
            <div>
              <h2 className="font-display text-lg font-semibold mb-1">Integrações</h2>
              <p className="text-sm text-muted-foreground">
                Conecte suas contas de redes sociais para desbloquear funcionalidades avançadas.
              </p>
            </div>
